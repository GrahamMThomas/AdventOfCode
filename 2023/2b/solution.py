...
def get_game_cube(line) -> int:
    ...
    for game in games:
        ...
        for entry in str_entries:
            ...
            maximums[MarbleColor[re_entry.group(2)]] = max(maximums[MarbleColor[re_entry.group(2)]], int(re_entry.group(1)))

    
    return maximums[MarbleColor.blue] * maximums[MarbleColor.green] * maximums[MarbleColor.red]
